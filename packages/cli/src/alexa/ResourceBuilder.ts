...
export class ResourceBuilder {
     ...
     */
    // buildInteractionModel(skill: AlexaSkill): v1.skill.interactionModel.InteractionModelData {
    ...
    //                 im.interactionModel?.languageModel?.intents?.push(this.buildIntentFromUtteranceTrigger(uTrigger));
    //             } else if (isIntentTrigger(intr.user.trigger)) {
    //                 let uTrigger = intr.user.trigger;
    //                 im.interactionModel?.languageModel?.intents?.push(this.buildIntentFromIntentTrigger(uTrigger));
    //             }
    //         });
    //     });
    //     // logger.logObject(im)
    ...
    //  * @param skill AlexaSkill
    //  */
    // buildSkillManifest(skill: AlexaSkill): v1.skill.Manifest.SkillManifestEnvelope {
    ...
    //     };
    // }
    // private buildIntentFromUtteranceTrigger(trigger: UtteranceTrigger): v1.skill.interactionModel.Intent {
    ...
    //     return intent;
    // }
    // private buildIntentFromIntentTrigger(trigger: IntentTrigger): v1.skill.interactionModel.Intent {
    //     let intent: v1.skill.interactionModel.Intent = {
    //         name: trigger.name,
    //         slots: [],
